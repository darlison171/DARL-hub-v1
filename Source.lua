...
-- Satix Hub - Script base Redz Hub UI
-- Script completo com UI do Redz, botão de minimizar, auto farm, auto quest, mastery e muito mais

local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/tbao143/Library-ui/main/Redzhubui.lua"))()

local Window = Library:MakeWindow({
    Title = "Satix Hub | Blox Fruits",
    SubTitle = "by ChatGPT",
    SaveFolder = "SatixHubConfig"
})

Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://16970846243", BackgroundTransparency = 0 },
    Corner = { CornerRadius = UDim.new(35, 1) }
})

local Tab = Window:MakeTab({"Main", "Auto Farm"})
local Section = Tab:AddSection({"Auto Farm Settings"})

_G.Settings = {
    AutoFarm = false,
    AutoQuest = false,
    AutoMastery = false,
    AutoMobSelect = "Bandit"
}

function AutoFarm()
    while _G.Settings.AutoFarm do
        pcall(function()
            -- ex: encontrar inimigo e atacar
            local enemy = workspace.Enemies:FindFirstChild(_G.Settings.AutoMobSelect)
...
function AutoQuest()
    while _G.Settings.AutoQuest do
        pcall(function()
            -- exemplo genérico, personalize com o NPC real do jogo
...
Tab:AddToggle({
    Name = "Auto Farm",
    Description = "Ativa o auto farm de mobs",
    Default = false,
    Callback = function(v)
...
Tab:AddToggle({
    Name = "Auto Quest",
    Description = "Pega missão automaticamente",
    Default = false,
    Callback = function(v)
...
Tab:AddToggle({
    Name = "Auto Mastery",
    Description = "Farme de mastery",
    Default = false,
    Callback = function(v)
        _G.Settings.AutoMastery = v
        if v then
            spawn(AutoMastery)
        end
    end
